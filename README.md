...
[![Build and run tests](https://github.com/xbmc/audiodecoder.openmpt/actions/workflows/build.yml/badge.svg?branch=Matrix)](https://github.com/xbmc/audiodecoder.openmpt/actions/workflows/build.yml)
